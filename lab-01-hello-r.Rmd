...
**NOTE** If you're reading this, it probably means you've completed these steps already, in which case, consider this review.

-   I have created a template Github repository ("repo").
    The first step is to generate your own private version of this repo using the Week 3 link: [CLICK HERE](https://docs.google.com/spreadsheets/d/1j1Vlib7LjWUAHAUrEdqktdHoYQYVsl5aXeLDDnEi3Cs/edit#gid=0).

-   The link will open a Github page where it asks you to name your repo.
    **Please name it: week-3-yourlastname**.
    For example, mine would be named: `week-3-mcnicol`

-   The repo you just generated now contains your assignment, as well as the "starter" file you'll edit as your graded work.

-   Now clone it into your RStudio workspace.
...
-   Hit OK, and you're good to go!
    RStudio will copy everything from your Github repo to your RStudio workspace.
...
Open the starter file named `lab-01.Rmd` in your project directory, change the author name to your name, and knit the document.
**This starter file is where you make all your changes. NOT in the instructions file** You do not need to make any edits to this instructions file (`lab-01-hello-r.Rmd`).
