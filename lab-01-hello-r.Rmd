...
-   Your Github repository (which we'll refer to as "repo" going forward) for this week (Week 3) is next to your name [here](https://docs.google.com/spreadsheets/d/1j1Vlib7LjWUAHAUrEdqktdHoYQYVsl5aXeLDDnEi3Cs/edit#gid=0).

-   If you have not already provided your **github user name**, please add it to the green box so we can give you access to your private repo.
    Please put your hand up and ask if you need help!
    (this applies at all times)

-   The repo you just opened contains your assignment, as well as the "starter" file you'll edit as your graded work.
